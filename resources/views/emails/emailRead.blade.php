                                            ...
                                            <div class="card-block email-card">
                                                <div class="row">
                                                    <div class="col-lg-12 col-xl-3">
                                                        <div class="user-head row header_title">Email</div>
                                                    </div>
                                                  ...
                                                  <div class="mail-body-content email-read">
                                                    <div class="card">
                                                      <div class="card-header">
                                                        <h5>{{ $email ->subject }}</h5>
                                                        <h6 class="f-right">{{ date("g:i a", strtotime($email->timestamp)) }}</h6>
                                                      </div>
                                                      <div class="card-block">
                                                        <div class="media m-b-20">
                                                          ...
                                                          <div class="media-body photo-contant">
                                                            ...
                                                            <div class="m-t-15">
                                                              <i class="icofont icofont-clip f-20 m-r-10"></i>Attachments <b>{{ $email->total_attachments }}</b>
